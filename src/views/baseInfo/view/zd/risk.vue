				        ...
				        <TabPane label="匝道信息" name="name1">
							...
							<Table :columns="zdxxColumns" :data="zdxxData">
								<template slot-scope="{ row }" slot="action">
						            <Button type="primary" size="small" ghost style="margin-right: 5px" @click="editZdxxModel(row)">编辑</Button>
						            <Poptip confirm placement="left-end" :transfer="true" title="确认删除该条数据吗？" @on-ok="removeZdxx(row)">
