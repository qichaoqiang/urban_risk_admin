		...
		<div v-show="step == 1">
			<Row type="flex" justify="center">
				<Col>
					...
					<Form :model="baseInfo" disabled hide-required-mark label-position="left" :label-width="140" style="width: 600px">
						<FormItem label="企业名称">
				            {{baseInfo.mc}}
				        </FormItem>
						<FormItem label="企业名称">
			...
			<Row type="flex" justify="center">
				<Col>
					...
					<Form :model="baseInfo" disabled ref="contactInfo" :rules="rules" hide-required-mark label-position="left" :label-width="140" style="width: 600px">
