				        ...
				        <TabPane label="堆场信息" name="name1">
							...
							<Table :columns="dcxxColumns" :data="dcxxData">
								<template slot-scope="{ row }" slot="action">
						            <Button type="primary" size="small" ghost style="margin-right: 5px" @click="editDcxxModel(row)">编辑</Button>
						            <Poptip confirm placement="left-end" :transfer="true" title="确认删除该条数据吗？" @on-ok="removeDcxx(row)">
