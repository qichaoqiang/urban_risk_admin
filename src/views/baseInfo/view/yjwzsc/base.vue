      ...
      <Row type="flex" justify="center">
        ...
        <Form disabled :model="baseInfo" ref="baseInfo" :rules="rules" hide-required-mark label-position="left" :label-width="140"
          ...
          <FormItem label="生产企业名称">
            <Input clearable v-model="baseInfo.scqymc" placeholder="生产企业名称"></Input>
          </FormItem>
          <FormItem label="地址">
            <Input clearable v-model="baseInfo.dz" placeholder="地址"></Input>
          </FormItem>
          <FormItem label="社会统一信用代码">
            <Input clearable v-model="baseInfo.shtyxydm" placeholder="社会统一信用代码"></Input>
          </FormItem>
          ...
          <FormItem label="隶属单位">
            <Input clearable v-model="baseInfo.lsdw" placeholder="隶属单位"></Input>
          </FormItem>
        </Form>
        </Col>
      </Row>
    ...
    methods: {
      async getBaseInfo() {
        let {
          ...
          data,
          message
        } = await api.getYjwzscBase(this.gkdx_id);
        if (status_code == 0) {
          this.form = data;
          let {
            scqymc, shtyxydm, wzlb, lsdw, qyfzr, dh, dz
          } = this.form
          this.baseInfo = {
            scqymc, shtyxydm, wzlb, lsdw, qyfzr, dh, dz
          }
      ...
      async submit() {
        ...
        let {
          status_code,
          message
        } = await api.addYjwzscBase(params);
        if (status_code == 200) {
