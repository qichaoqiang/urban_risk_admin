					...
					<Tabs value="name1">
				        <TabPane label="地铁运行站点信息" name="name1">
							...
							<Table :columns="dtyxzdxxColumns" :data="dtyxzdxxData">
								...
								<template slot-scope="{ row }" slot="action">
						            <Button type="primary" size="small" ghost style="margin-right: 5px" @click="editDtyxzdxxModel(row)">编辑</Button>
						            <Poptip confirm placement="left-end" :transfer="true" title="确认删除该条数据吗？" @on-ok="removeDtyxzdxx(row)">
				        ...
				        <TabPane label="地铁运行线路信息" name="name2">
							...
							<Table :columns="dtyxxlxxColumns" :data="dtyxxlxxData">
								...
								<template slot-scope="{ row }" slot="action">
						            <Button type="primary" size="small" ghost style="margin-right: 5px" @click="editDtyxxlxxModel(row)">编辑</Button>
						            <Poptip confirm placement="left-end" :transfer="true" title="确认删除该条数据吗？" @on-ok="removeDtyxxlxx(row)">
								        <Button type="error" size="small" ghost>删除</Button>
								    </Poptip>
						        </template>
							</Table>
				        ...
				        <TabPane label="地铁运行组织" name="name3">
							...
							<Table :columns="dtyxzzColumns" :data="dtyxzzData">
								<template slot-scope="{ row }" slot="action">
						            <Button type="primary" size="small" ghost style="margin-right: 5px" @click="editDtyxzzModel(row)">编辑</Button>
						            <Poptip confirm placement="left-end" :transfer="true" title="确认删除该条数据吗？" @on-ok="removeDtyxzz(row)">
								        <Button type="error" size="small" ghost>删除</Button>
								    </Poptip>
						        </template>
							</Table>
