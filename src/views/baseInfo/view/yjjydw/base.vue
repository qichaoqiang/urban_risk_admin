    ...
    <div v-show="step == 1">
      <Row type="flex" justify="center">
        ...
        <Form disabled :model="baseInfo" ref="baseInfo" :rules="rules" hide-required-mark label-position="left" :label-width="140"
          ...
          <FormItem label="单位性质">
            <Input clearable v-model="baseInfo.dwxz" placeholder="单位性质"></Input>
          </FormItem>
          <FormItem label="队伍隶属单位/牵头单位" prop="dwlsdw">
            <Input clearable v-model="baseInfo.dwlsdw" placeholder="队伍隶属单位/牵头单位"></Input>
          </FormItem>
          ...
          <FormItem label="专业分类">
            <Input clearable v-model="baseInfo.zyfl" placeholder="专业分类"></Input>
          </FormItem>
          <FormItem label="驻地位置">
            <Input clearable v-model="baseInfo.zdwz" placeholder="驻地位置"></Input>
          </FormItem>
          <FormItem label="队伍总人数">
            <InputNumber :min="0" v-model="baseInfo.sscsmj"></InputNumber>
          </FormItem>
          <FormItem label="传真">
            <Input clearable v-model="baseInfo.cz" placeholder="传真"></Input>
          </FormItem>
        </Form>
        </Col>
      </Row>
        ...
        <Form disabled :model="baseInfo" label-position="left" :label-width="140" style="width: 600px">
          <FormItem label="队长">
            <Row type="flex" :gutter="20">
              <Col span="8">
              <Input clearable v-model="baseInfo.dz" placeholder="姓名"></Input>
              </Col>
              <Col span="16">
              <Input clearable v-model="baseInfo.dzdh" placeholder="电话"></Input>
              </Col>
              <Col span="24">
    ...
    methods: {
      async getBaseInfo() {
        let {
          ...
          data,
          message
        } = await api.getYjjydwBase(this.gkdx_id);
        if (status_code == 0) {
          this.form = data;
          let {
            dwmc, dwxz, dwlsdw, zyfl, zdwz, dz, dwzrs, dzdh, zbdh, cz
          } = this.form
          this.baseInfo = {
            dwmc, dwxz, dwlsdw, zyfl, zdwz, dz, dzdh, zbdh, cz
          }
          this.baseInfo.dwzrs = dwzrs ? Number(dwzrs) : 0
      ...
      async submit() {
        ...
        let {
          status_code,
          message
        } = await api.addYjjydwBase(params);
        if (status_code == 200) {
