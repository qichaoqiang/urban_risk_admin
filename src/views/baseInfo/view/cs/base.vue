	...
	export default {
		...
		methods: {
			async getBaseInfo() {
				...
				if(status_code == 0) {
					this.form = data;
					let { scmc, tyshxydm, hydm, yysj1, yysj2, kfdw, zzdjdz, yydw, yt, gm, jbr, jbrdh, jbryx, csfzr, csfzrdh, fgaqfzr, fgaqfzrdh, dz, lngAndLat, dyfw, jzzdmj, ztjzcs, tysj, jzlx } = this.form
					this.baseInfo = { scmc, tyshxydm, hydm, yysj1, yysj2, kfdw, zzdjdz, yydw, yt, gm, jbr, jbrdh, jbryx, csfzr, csfzrdh, fgaqfzr, fgaqfzrdh, dz, lngAndLat, dyfw, jzlx }
