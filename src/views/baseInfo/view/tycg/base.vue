		...
		<div>
				...
				<Col>
					...
					<Form disabled :model="baseInfo" label-position="left" :label-width="140" style="width: 600px">
				        ...
				        <FormItem label="所属区域">
				         ...
				         <FormItem label="场馆类型">
				        	<Select clearable v-model="baseInfo.cglx" placeholder="场馆类型">
				                <Option v-for="item in cglxList" :key="item" :value="item">{{item}}</Option>
				            </Select>
				        </FormItem>
				        <FormItem label="场馆占地面积（㎡）">
				        ...
				        <FormItem label="场馆简介">
				            <Input clearable type="textarea" :rows="4" v-model="baseInfo.cgjj" placeholder="场馆简介"></Input>
				        </FormItem>
					</Form>
				</Col>	
			</Row>	
			...
			<Row type="flex" justify="center">
				<Col>
					...
					<Form disabled :model="baseInfo" label-position="left" :label-width="140" style="width: 600px">
						<FormItem label="场馆负责人">
				        	<Row type="flex" :gutter="20">
					        	<Col span="8">
				        			<Input clearable v-model="baseInfo.cgfzr" placeholder="姓名"></Input>
				        		</Col>
				        		<Col span="16">
				        			<Input clearable v-model="baseInfo.cgfzrdh" placeholder="电话"></Input>
				        		</Col>
				        	</Row>
				        </FormItem>
	...
	export default {
		...
		data() {
			return {
				...
				cglxList: ['综合性场馆', '露天体育场', '室内体育馆', '游泳馆', '其他'],
				jzlxList: ['综合性建筑', '独立建筑'],
				yyztList: ['在运行', '封闭升级', '闭馆'],
				sfzgyyList: [
					{
						value: 0,
						name: '否'
			...
			async nextStep() {
				...
				if(status_code == 200) {
					...
					if(this.$route.query.type == 2) {
						...
						let { status_code, data } = await api.getTycgBase()
						if(status_code == 200) {
