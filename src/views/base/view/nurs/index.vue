  ...
  <div class="page">
    <div v-show="step == 1">
      <Row type="flex" justify="center">
        ...
        <Form :model="baseInfo" ref="baseInfo" :rules="rules" hide-required-mark label-position="left" :label-width="140"
          ...
          <FormItem label="所属辖区" prop="quyu">
            <Cascader clearable change-on-select v-model="baseInfo.quyu" :data="areaList" :load-data="loadArea"
          ...
          <FormItem label="行业门类" prop="hyml">
            <Cascader clearable change-on-select v-model="baseInfo.hyml" :data="industryList" :load-data="loadIndustry"
      ...
      <Row type="flex" justify="center">
        ...
        <Form :model="baseInfo" ref="jzInfo" :rules="rules" hide-required-mark label-position="left" :label-width="140"
          style="width: 600px">
      ...
      <Row type="flex" justify="center">
        ...
        <Form :model="baseInfo" ref="contactInfo" :rules="rules" hide-required-mark label-position="left" :label-width="140"
          style="width: 600px">
          <FormItem label="经办人">
    ...
    methods: {
      async getBaseInfo() {
        let {
          ...
          data,
          message
        } = await api.getNursBase(this.gkdx_id);
        if (status_code == 0) {
          this.form = data;
          let {
            jbr,
