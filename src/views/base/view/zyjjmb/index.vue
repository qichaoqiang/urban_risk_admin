	...
	export default {
		...
		methods: {
			async getBaseInfo() {
				...
				if(status_code == 0) {
					this.form = data;
					let { zyjjmbmc, bh, mbjb, mbgnlb, mbhylb, mbkjlb, dz, zczegm, ssdw, ssdwfzr, lxfs, fhbzcs, sfyzsj, sfyfcszh, sfpbrfzydw, jwdfw } = this.form
					this.baseInfo = { zyjjmbmc, bh, mbjb, mbgnlb, mbhylb, mbkjlb, dz, ssdw, ssdwfzr, lxfs, fhbzcs, jwdfw }
