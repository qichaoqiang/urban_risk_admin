...
<script>
	...
	export default {
     ...
     //            	szgqmc: [{ required: true, message: '请输入', trigger: 'change' }],
     ...
     //            	fgaqfzrdh: [{ required: true, message: '请输入', trigger: 'change' }],
		...
		methods: {
			async getBaseInfo() {
				...
				if(status_code == 0) {
					this.form = data;
					let { qymc, tyshxydm, zcdz, zgrs, glrysl, hyml, hydm, szgqmc, yxzt, jbr, jbrdh, jbryx, qyfzr, qyfzrdh, fgaqfzr, fgaqfzrdh, lngAndLat, jyfw, tysj, mtdz } = this.form
					this.baseInfo = { qymc, tyshxydm, zcdz, hydm, szgqmc, yxzt, jbr, jbrdh, jbryx, qyfzr, qyfzrdh, fgaqfzr, fgaqfzrdh, jyfw, mtdz, zgrs, glrysl, tysj }
