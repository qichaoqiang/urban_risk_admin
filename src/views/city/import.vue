<template>
  <div class="container" style="position: relative;">
    <div>
      <div>
        <div style="color: #e23114">请按以下格式导入风险源清单，也可以选择相应风险源类别的excel填报表格文件，导入详细数据。</div>
        ...
        <Form label-position="left" :label-width="120" style="margin-top: 16px">
          <FormItem label="风险源类别">
            <Cascader readonly change-on-select v-model="fxylb" :data="fxylbList" :load-data="loadFxylb"
